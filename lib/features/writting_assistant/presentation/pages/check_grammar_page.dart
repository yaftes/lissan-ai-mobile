...
class _CheckGrammarPageState extends State<CheckGrammarPage> {
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  child: const Icon(Icons.paste, color: Color(0xFF112D4F)),
                ),
                InkWell(
                  onTap: () {
                    setState(() {
  ...
  Widget _checkButton() {
    return ElevatedButton(
      ...
      onPressed: _charCount >= 1
          ? () {
              context.read<WrittingBloc>().add(
                CheckGrammarEvent(englishText: _controller.text),
              );
            }
          : null,
      child: Row(
  ...
  Widget _resultSection(issues, GrammarLoaded state) {
    return Container(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.inter(
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                      color: const Color.fromRGBO(22, 101, 52, 1),
                    ),
                  ),
                          ...
                          children: [
                            ...
                            RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: '"${correction.originalPhrase}"',
                                    style: GoogleFonts.inter(
                                      fontSize: 14,
                                  ...
                                  const TextSpan(text: ' → '),
                                  TextSpan(
                                    text: correction.correctedPhrase,
                                    style: GoogleFonts.inter(
                                      fontSize: 14,
                                      color: Colors.green,
                                      fontWeight: FontWeight.w600,
                            ...
                            Text(
                              _showEnglish
                                  ? correction.explanation.english
                                  : correction.explanation.amharic,
                              style: GoogleFonts.inter(
                                fontSize: 12,
  ...
  Widget _improvedVersion(GrammarLoaded state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          children: [
            const Icon(Icons.bolt_sharp, color: Colors.green, size: 26),
            const SizedBox(width: 5),
            Text(
              'Improved Version',
              style: GoogleFonts.inter(
            ...
            children: [
              ...
              Align(
                ...
                child: TextButton.icon(
                  ...
                  onPressed: () {
                    Clipboard.setData(
                      ClipboardData(text: state.grammarResult.correctedText),
                    );
                    ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  label: Text(
                    'Copy',
                    style: GoogleFonts.inter(color: const Color(0xFF112D4F)),
                  ),
                ),
              ),
            ],
  ...
  Widget _writingTips() {
    return Column(
      children: [
        ...
        const SizedBox(height: 15),
        _writingTip(tipName: 'Consider using more varied sentence structures'),
        const SizedBox(height: 5),
        _writingTip(tipName: 'Add transition words to improve flow'),
        const SizedBox(height: 5),
        _writingTip(tipName: 'Use active voice where possible'),
        const SizedBox(height: 5),
        _writingTip(tipName: 'Check for consistent tense throughout'),
      ],
    );
  }
