...
class FeedbackPopup {
  static void showFeedbackPopup(BuildContext context, AnswerFeedbackModel feedback) {
    showDialog(
      context: context,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text('[${point.type}] - ${point.focusPhrase}',
                              style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                          subtitle: Text(point.suggestion , style: const TextStyle(fontSize: 12)),
                        ),
                      );
                    },
                  ),
